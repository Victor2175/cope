from robust_analysis import ridge_estimator, train_robust_model,compute_weights, leave_one_out, leave_one_out_procedure, cross_validation_loo,\
...
with open('betas_ridge.pkl', 'wb') as f:
