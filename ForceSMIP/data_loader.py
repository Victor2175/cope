...
# Mapping from user variable names to file and netCDF variable names
VARIABLE_MAP = {
...
class ForceSMIPDataLoader:
    ...
    def __init__(self, base_path: str):
        """
        Initialize the data loader with a base path to the dataset.
        """
    ...
    def _map_variable(self, variable):
        ...
        Returns the tuple (file variable name, netCDF variable name).
        """
    ...
    def load_training_data(self, variable: str = 'tas') -> Tuple[Dict, Dict, np.ndarray, np.ndarray]:
        ...
        Args:
            variable: Variable name ('tas', 'tos', etc.)
        ...
        # Try different subdirectories to find the correct data path
        ...
        for idx_m, model_dir in enumerate(dir_list):
            ...
            # Allocate arrays for each model
            ...
            # Loop over ensemble members/files
            for idx_f, file in enumerate(file_list):
                ...
                with netcdf.Dataset(file_path, 'r') as nc_file:
                    ...
                    # Monthly centering: subtract monthly mean from each month
                    data_tmp = data.copy()
                    data_tmp[np.abs(data_tmp) > 1e9] = np.nan  # Mask outliers
            ...
            # Compute forced response as ensemble mean across members
    ...
    def load_test_data(self, variable: str = 'tas',
        ...
        Returns:
            ...
            temporal_means: Monthly means for centering
        """
        ...
        # Loop over files and models to load test data
    ...
    def load_ground_truth(self, variable: str = 'tas',
        ...
        # Path to ground truth ensemble means
        ...
        # Allocate array for ground truth data
        if variable != 'zmta':
        ...
        # Loop over files and models to load ground truth
    ...
    def load_estimates(self, variable: str = 'tas',
        ...
        # Loop over files and models to load estimates
        for file in file_list:
        ...
        # Center specific methods by subtracting monthly mean
