...
# Global models
y_pred_ridge = (x_test_filtered @ w_ridge_cv + temporal_means).reshape(x_test.shape[0], x_test.shape[1], latitude.shape[0], longitude.shape[0])
y_pred_ridge_lr = (x_test_filtered @ w_ridge_lr_cv + temporal_means).reshape(x_test.shape[0], x_test.shape[1], latitude.shape[0], longitude.shape[0])

y_pred_ridge_smooth = (x_test_smooth @ w_ridge_cv + temporal_means).reshape(x_test.shape[0], x_test.shape[1], latitude.shape[0], longitude.shape[0])
y_pred_ridge_lr_smooth = (x_test_smooth @ w_ridge_lr_cv + temporal_means).reshape(x_test.shape[0], x_test.shape[1], latitude.shape[0], longitude.shape[0])
