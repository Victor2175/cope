...
mu_range_tmp = np.array([10.0, 50.0, 100.0, 500.0, 1000.0,5000.0])
lambda_range_tmp = np.array([10.0, 100.0,250.0, 500.0,1000.0])
nu_range_tmp = np.array([1.0, 10.0,100.0,500.0, 1000.0])

# mu_range_tmp = np.array([1000.0])
# lambda_range_tmp = np.array([100.0])
# nu_range_tmp = np.array([100.0])
...
w_ridge, rmse_ridge, weights_ridge, training_loss_ridge = \
                        cross_validation_procedure(x,y,means,vars,\
                                                    ...
                                                    method='ridge', rank=None, lambda_range=lambda_range_tmp, mu_range = mu_range_tmp, nu_range = nu_range_tmp ,\
...
w_ridge_lr, rmse_ridge_lr, weights_ridge_lr, training_loss_ridge_lr = \
                            cross_validation_procedure(x,y,means,vars,\
                                                    lon_size,lat_size,notnan_idx,nan_idx,time_period=34,\
                                                    method='ridge', rank=10, lambda_range=lambda_range_tmp, mu_range = mu_range_tmp ,\
                                                    lr=1e-5,nb_gradient_iterations=20,dtype=DTYPE,verbose=False)
...
w_robust_trace_norm, rmse_robust_trace_norm, weights_robust_trace_norm,training_loss_robust_trace_norm = \
                            cross_validation_procedure(x,y,means,vars,\
                            lon_size,lat_size,notnan_idx,nan_idx,time_period=34,\
                            method='robust_trace_norm', rank=None, lambda_range=lambda_range_tmp, mu_range = mu_range_tmp, nu_range=nu_range_tmp,\
                            lr=1e-6,nb_gradient_iterations=50,dtype=DTYPE,verbose=False)



with open('results/robust_trace_norm_scaled/w_robust_trace_norm.pkl', 'wb') as f:
    pickle.dump(w_robust_trace_norm, f)

with open('results/robust_trace_norm_scaled/rmse_robust_trace_norm.pkl', 'wb') as f:
    pickle.dump(rmse_robust_trace_norm, f)

with open('results/robust_trace_norm_scaled/weights_robust_trace_norm.pkl', 'wb') as f:
    pickle.dump(weights_robust_trace_norm, f)

with open('results/robust_trace_norm_scaled/training_loss_robust_trace_norm.pkl', 'wb') as f:
    pickle.dump(training_loss_robust_trace_norm, f)
...
w_robust, rmse_robust, weights_robust, training_loss_robust = \
                        cross_validation_procedure(x,y,means,vars,\
                        lon_size,lat_size,notnan_idx,nan_idx,time_period=34,\
                        method='robust', rank=None, lambda_range=lambda_range_tmp, mu_range = mu_range_tmp, nu_range=nu_range_tmp ,\
                        lr=1e-6,nb_gradient_iterations=50,dtype=DTYPE,verbose=False)

## save files
with open('results/robust_scaled/w_robust.pkl', 'wb') as f:
    pickle.dump(w_robust, f)

with open('results/robust_scaled/rmse_robust.pkl', 'wb') as f:
    pickle.dump(rmse_robust, f)

with open('results/robust_scaled/weights_robust.pkl', 'wb') as f:
    pickle.dump(weights_robust, f)

with open('results/robust_scaled/training_loss_robust.pkl', 'wb') as f:
...
w_robust_lr, rmse_robust_lr, weights_robust_lr,training_loss_robust_lr = \
                            cross_validation_procedure(x,y,means,vars,\
                                lon_size,lat_size,notnan_idx,nan_idx,time_period=34,\
                                method='robust', rank=20, lambda_range=lambda_range_tmp, mu_range = mu_range_tmp, nu_range=nu_range_tmp ,\
                                lr=1e-6,nb_gradient_iterations=50,dtype=DTYPE,verbose=False)



with open('results/robust_low_rank_scaled/w_robust_lr.pkl', 'wb') as f:
    pickle.dump(w_robust_lr, f)

with open('results/robust_low_rank_scaled/rmse_robust_lr.pkl', 'wb') as f:
    pickle.dump(rmse_robust_lr, f)

with open('results/robust_low_rank_scaled/weights_robust_lr.pkl', 'wb') as f:
    pickle.dump(weights_robust_lr, f)

with open('results/robust_low_rank_scaled/training_loss_robust_lr.pkl', 'wb') as f:
