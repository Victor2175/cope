...
# Load test data
tier_set = 3
test_models = [f'{tier_set}A', f'{tier_set}B', f'{tier_set}C', f'{tier_set}D', f'{tier_set}E', f'{tier_set}F', f'{tier_set}G', f'{tier_set}H', f'{tier_set}I', f'{tier_set}J', f'{tier_set}K', f'{tier_set}L', f'{tier_set}M', f'{tier_set}N', f'{tier_set}O', f'{tier_set}P', f'{tier_set}Q', f'{tier_set}R', f'{tier_set}S', f'{tier_set}T', f'{tier_set}U']
print("\nLoading test data...")
...
path_tier3 = '/home/vcohen/cope/results/tier3/'

y_pred_ridge_xr.to_netcdf(f'{path_tier3}predictions_{variable}_ridge_tier3.nc')
y_pred_ridge_lr_xr.to_netcdf(f'{path_tier3}predictions_{variable}_ridge_lr_tier3.nc')
y_pred_ridge_smooth_xr.to_netcdf(f'{path_tier3}predictions_{variable}_ridge_smooth_tier3.nc')
y_pred_ridge_lr_smooth_xr.to_netcdf(f'{path_tier3}predictions_{variable}_ridge_lr_smooth_tier3.nc')